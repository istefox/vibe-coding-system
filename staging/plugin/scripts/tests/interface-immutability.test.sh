...
# IH2 removed (ADR-0193): ci.yml, the second registry this pinned, was deleted — docs-ci.yml's
# shell-tests list above (IH1) is now the only harness runner, and pairs-completeness.test.sh's
