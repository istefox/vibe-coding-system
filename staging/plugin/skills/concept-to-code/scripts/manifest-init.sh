...
echo "manifest_schema_version: \"1.4\"" > "$T"
echo "topic: \"$slug\"" >> "$T"
echo "topic_full_title: \"$title_esc\"" >> "$T"
echo "project_root: \"$root\"" >> "$T"
echo "mode: \"$mode\"" >> "$T"
echo "anonymize: false" >> "$T"
echo "use_codex_review: false" >> "$T"
echo "step5_codex_review_asked: false" >> "$T"
echo "step5_codex_review_model: null" >> "$T"
echo "step5_codex_review_effort: null" >> "$T"
echo "use_codex_tester: false" >> "$T"
echo "step5_codex_tester_asked: false" >> "$T"
echo "use_codex_coder: false" >> "$T"
echo "step5_codex_coder_model: null" >> "$T"
echo "step5_codex_coder_effort: null" >> "$T"
