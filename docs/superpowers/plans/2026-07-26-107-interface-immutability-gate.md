...
- [x] **Task 1 — RED harness.** `staging/plugin/scripts/tests/interface-immutability.test.sh`.
...
- [x] **Task 2 — `interface-check.sh`.** New script; put it beside its siblings in
...
- [x] **Task 3 — the §D3 contract table.** Add it at the c2c call site: four scripts, two reporters,
...
- [x] **Task 4 — c2c Step 6 wiring + standalone CI exposure.** Call it in Step 6 before the review
...
- [x] **Task 5 — architect proposal at Gate 2.** `staging/plugin/agents/architect.md`: when the plan
